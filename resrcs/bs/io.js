module.exports = {
    ...
    javascript: {in: "sources/client/assets/javascript", out: "server/assets/javascript"},
    typescript: {in: "sources/client/assets/javascript", out: "server/assets/javascript/compiled"}
};
